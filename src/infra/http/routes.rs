  ...
  <head>
    ...
    <style>
      ...
      .metric-sort-control {
        ...
        gap: 0.4rem;
        font-size: 0.85rem;
        color: rgba(156, 190, 255, 0.82);
      }
      .metric-sort-control select {
        background: rgba(18, 34, 58, 0.65);
        border: 1px solid rgba(96, 142, 220, 0.4);
      ...
      .metric-sort-control select:focus {
        outline: 2px solid rgba(79, 142, 253, 0.6);
        outline-offset: 2px;
      }
      .telemetry-stats {
        display: grid;
      ...
      .chart-legend .legend-axis {
        display: inline-flex;
        align-items: center;
        padding: 0.2rem 0.55rem;
        border-radius: 0.75rem;
        background: rgba(16, 34, 60, 0.55);
      ...
      .service-metrics-table th,
      .service-metrics-table td {
        text-align: left;
      }
      .service-metrics-table th.numeric,
      .service-metrics-table td.numeric {
        text-align: right;
      }
      .metric-stale {
        color: rgba(255, 193, 118, 0.86);
        font-size: 0.75rem;
        margin-left: 0.35rem;
        text-transform: uppercase;
      ...
      .chart-series-toggle .series-toggle {
        display: inline-flex;
        align-items: center;
        gap: 0.35rem;
      ...
      .chart-series-toggle .series-toggle input[type='checkbox'] {
        accent-color: #4f8efd;
        width: 14px;
        height: 14px;
      }
    ...
    <div>
      ...
      <section class="page" data-page="telemetry" data-visible="false">
        ...
        <div class="telemetry-grid">
          ...
          <div class="chart-series-toggle" data-series-toggle aria-label="Metrikauswahl"></div>
          ...
          <article class="card metric-table-card service-resource-card">
            <div class="metric-table-title">
              <h3>Service Ressourcen</h3>
              <label class="metric-sort-control">
                Sortierung:
                <select data-service-sort>
                  <option value="cpu-desc">CPU ↓</option>
                  <option value="cpu-asc">CPU ↑</option>
                  <option value="memory-desc">RAM ↓</option>
                  <option value="memory-asc">RAM ↑</option>
                  <option value="updated-desc">Aktualisiert ↓</option>
                  <option value="updated-asc">Aktualisiert ↑</option>
                  <option value="id-asc">Service A→Z</option>
                  <option value="id-desc">Service Z→A</option>
                </select>
              </label>
            </div>
            <div class="metric-table-scroll">
              <table class="metric-table service-metrics-table">
                <thead>
                  <tr>
                    <th>Service</th>
                ...
                <tbody data-service-metrics>
                  <tr>
                    <td colspan="5">Keine Ressourcen-Metriken gemeldet.</td>
                  </tr>
                </tbody>
              </table>
            </div>
            <small class="metric-table-meta" data-service-metrics-meta>–</small>
          </article>
        </div>
      </section>
