...
pub use context::{ClauseKind, Expecting, SqlContext, StatementKind};
pub use engine::{CompletionResult, SqlCompletionEngine};
pub use schema::SchemaCache;
pub use tokenizer::{SqlKeywordKind, SqlTokenizer, Token, TokenKind};
...
mod integration_tests {
    ...
    fn test_empty_suggests_statements() {
        ...
        assert!(
            not_has(&result, "FROM"),
            "FROM should not be suggested at start"
        );
        assert!(
            not_has(&result, "WHERE"),
            "WHERE should not be suggested at start"
        );
    }
    ...
    fn test_select_star_only_from() {
        ...
        assert!(
            has(&result, "FROM"),
            "FROM should be suggested after SELECT *"
        );
        assert!(
            not_has(&result, "*"),
            "* should not be suggested after SELECT *"
        );
        assert!(
            not_has(&result, "DISTINCT"),
            "DISTINCT should not be suggested after SELECT *"
        );
        assert!(
            not_has(&result, "WHERE"),
            "WHERE should not be suggested before FROM"
        );
    }
    ...
    fn test_select_star_f_only_from() {
        ...
        assert!(
            result.len() == 1,
            "Only FROM should be suggested, got: {:?}",
            result
        );
    }
    ...
    fn test_insert_only_into() {
        ...
        assert!(
            has(&result, "INTO"),
            "INTO should be suggested after INSERT"
        );
        assert!(
            result.len() == 1,
            "Only INTO should be suggested after INSERT, got: {:?}",
            result
        );
    }
    ...
    fn test_update_table_only_set() {
        ...
        assert!(
            has(&result, "SET"),
            "SET should be suggested after UPDATE table"
        );
        assert!(
            not_has(&result, "WHERE"),
            "WHERE should not be suggested before SET"
        );
        assert!(
            not_has(&result, "FROM"),
            "FROM should not be suggested for UPDATE"
        );
    }
    ...
    fn test_delete_only_from() {
        ...
        assert!(
            has(&result, "FROM"),
            "FROM should be suggested after DELETE"
        );
        assert!(
            result.len() == 1,
            "Only FROM should be suggested after DELETE, got: {:?}",
            result
        );
    }
    ...
    fn test_from_suggests_tables() {
        ...
        assert!(
            not_has(&result, "SELECT"),
            "SELECT should not be suggested after FROM"
        );
        assert!(
            not_has(&result, "FROM"),
            "FROM should not be suggested after FROM"
        );
    }
    ...
    fn test_where_suggests_columns() {
        ...
        assert!(
            not_has(&result, "ticket_id"),
            "ticket_id should not be suggested (not in users)"
        );
    }
    ...
    fn test_where_column_suggests_operators() {
        ...
        assert!(
            not_has(&result, "AND"),
            "AND should not be suggested before operator"
        );
    }
    ...
    fn test_join_suggests_tables() {
        ...
        assert!(
            has(&result, "tickets"),
            "tickets should be suggested for JOIN"
        );
        assert!(
            has(&result, "comments"),
            "comments should be suggested for JOIN"
        );
    }
    ...
    fn test_join_table_suggests_on() {
        ...
        assert!(
            has(&result, "ON"),
            "ON should be suggested after JOIN table"
        );
    }
    ...
    fn test_alias_qualified_column() {
        ...
        assert!(
            not_has(&result, "ticket_id"),
            "ticket_id should not be in users"
        );
    }
    ...
    fn test_order_by_suggests_columns() {
        ...
        assert!(
            has(&result, "name"),
            "name should be suggested for ORDER BY"
        );
    ...
    fn test_semicolon_resets_context() {
        ...
        assert!(
            has(&result, "SELECT"),
            "New statement should suggest SELECT"
        );
        assert!(
            has(&result, "INSERT"),
            "New statement should suggest INSERT"
        );
    }
    ...
    fn test_group_by() {
        ...
        assert!(
            has(&result, "role"),
            "role should be suggested for GROUP BY"
        );
    }
}
